...
Phase B (code changes): not started. Kickoff prompt ready for a fresh Cursor agent.
...
1. Confirm v0-import tag pushed, repo visibility PRIVATE, baseline test count recorded
2. Phase B code changes (B0 to B6), one commit each, pytest after each; review diffs of run_experiment.py and evaluate_instruction_holdout.py in the Claude Project
3. Phase C partition preview, Phase D Mac smoke tests
